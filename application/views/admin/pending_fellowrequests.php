	...
	<div id="cl-wrapper" class="fixed-menu">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/admin/pending_fellowrequests') ?>">Pending Fellow Requests</a></li>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">PENDING FELLOW REQUESTS </h3>
            </div>
            <div class="content">
