	...
	<div id="cl-wrapper" class="fixed-menu">
          ...
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-smile-o"></i><span>Supervisors</span></a>
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/admin/edit_supervisor') ?>">Edit Existing</a></li>
                  </ul>
              </li>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">REGISTERED SUPERVISORS</h3>
            </div>
            <div class="content">
              <div class="table-responsive">
                <table class="table table-bordered" id="datatable-icons" >
                  ...
                  <tbody>
                  <?php for ($i=0;$i<count($supervisors);$i++){
                   ?>
                                      <tr class="gradeX">
                      <td><?php echo $supervisors[$i]['username']  ;?></td>
                      <td><?php echo $supervisors[$i]['useremail'] ;?></td>
                               <td class="center"></td>
                    </tr>
                    <?php }
                    ?>
