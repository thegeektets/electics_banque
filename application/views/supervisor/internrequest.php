          ...
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                <ul class="sub-menu">
                  <li class="active"><a href="<?php echo base_url('index.php/supervisor/newinternrequest') ?>">Request Interns</a></li>
        ...
        <div class="col-sm-12">
          ...
          <div class="tab-container">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#intern">Request Intern(s)</a></li>
                      </ul>
            <div class="tab-content">
              <div id="intern" class="tab-pane active cont">
            <h3 class="widget-title">Request New Intern(s)</h3>
                <div class="row friends-list">



                            <form role="form" style="color:#000;" class="form-horizontal" <?php echo form_open('supervisor/newinternrequest'); ?>
             
                  <div class="form-group spacer2">
                    <div class="col-sm-3"></div>
                    </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="skills">Skills,Qualifications & Experience of the Desired Intern</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="number">Number of Intern(s) Required</label>
                    <div class="col-sm-9">
                      <input type="text" placeholder="number of interns" value="<?php echo set_value('number'); ?>" id="number" name="number" class="form-control">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="summary">Summary of the Project where internship will be undertaken </label>
                    <div class="col-sm-9">
                  ...
                  <div style="color:#DF0D8A" id="summary-error"> <?php echo form_error('summary'); ?></div>
                     ...
                     <!--
                       <div class="form-group">
                    <label class="col-sm-3 control-label" for="summary">Suggested Interns</label>
                    <div class="col-sm-9">
                    ...
                    -->
                  <div class="form-group">
                    <label class="col-sm-3 control-label" for="purpose">Purpose of Internship </label>
                    <div class="col-sm-9">
                      <textarea type="text" name="purpose" value="<?php echo set_value('purpose'); ?>" id="purpose" class="form-control">
                  ...
                  <div style="color:#DF0D8A"  id="budgetholderemail-error"> <?php echo form_error('budgetholderemail'); ?></div>
                    ...
                    <div class="col-sm-9">
                      <input type="text" placeholder="Charge Code"  value="<?php echo set_value('costcenter'); ?>"  id="costcenter"  name="costcenter" class="form-control">
